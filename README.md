...
```html
<script src="https://cdn.jsdelivr.net/npm/ass-html5@0.3.5/dist/ass.min.js"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/ass-html5@0.3.5/dist/ass.min.js" defer></script>
